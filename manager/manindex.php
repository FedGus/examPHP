...
<body>
	<header>
		...
		<span style="position: absolute; top: 20px; right: 100px; color: white;">Добро пожаловать, Менеджер 
		<?php
	...
	if ($_GET['p']=='add') {include 'manadd.php';}
	if ($_GET['p']=='edit') {include 'manedit.php';}
	if ($_GET['p']=='delete') {include 'mandelete.php';}
	if ($_GET['p']=='exit') {
